...
public class GetImageFirstUrlApi {
    ...
    public static void main(String[] args) {
        // 请求目标 URL
        String url = "https://graph.baidu.com/s?card_key=&entrance=GENERAL&extUiData[isLogoShow]=1&f=all&isLogoShow=1&session_id=7533059134587724039&sign=121b0402714a5699d357601759137690&tpl_from=pc";
