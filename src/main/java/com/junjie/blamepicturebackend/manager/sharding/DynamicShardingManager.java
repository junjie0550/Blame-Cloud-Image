package com.junjie.blamepicturebackend.manager.sharding;
...
public class DynamicShardingManager {
    ...
    private void updateShardingTableNodes() {
        ...
        // blame_picture.picture_112321321,blame_picture.picture_1123213123
        String newActualDataNodes = tableNames.stream()
                .map(tableName -> "blame_picture." + tableName) // 确保前缀合法
